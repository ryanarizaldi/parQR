...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1>Tambah Kendaraan Kepala Departemen</h1>
            </div>
            <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Tambah Kendaraan Kepala Departemen</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="<?= base_url() ?>/Parkiran/addDeptAction">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Kepala Departemen</span>
                        </div>
                        <input type="text" class="form-control" id="jabatan" placeholder="Masukkan nama departemen yang dijabat" name="jabatan">
                    </div>
                  </div>
                <!-- /.card-body -->
