            ...
            <div class="card">
              <div class="card-header">
                <div class="d-flex justify-content-between">
                      <h3 class="card-title">Daftar Parkiran Kepala Divisi</h3>
                      <a href="<?= base_url('divisi/add') ?>" class="btn btn-success"><i class="fas fa-plus  "></i> Tambah Kendaraan</a>
                  </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php $num=1; foreach ($divisi as $key):?>
                        <tr>
                            <td><?= $num ?></td>
                            <td><?= $key['no_plat'] ?></td>
