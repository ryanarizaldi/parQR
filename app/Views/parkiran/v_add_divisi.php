        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="<?= base_url() ?>/Parkiran/addDivAction">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text">Kepala Divisi</span>
                        </div>
                        <input type="text" class="form-control" id="jabatan" placeholder="Masukkan nama divisi yang dijabat" name="jabatan">
                    </div>
                  </div>
                <!-- /.card-body -->
