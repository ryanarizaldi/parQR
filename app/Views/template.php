...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">par<b>QR</b></span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url("vip")?>" class="nav-link ">
                  <i class="fas fa-star nav-icon"></i>
                  <p>VIP</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url("direksi")?>" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 - Departemen Core Divisi TI </strong>
...
<script src="<?= base_url()?>/assets/swal/sweetalert2.js"></script>
<!-- jQuery -->
